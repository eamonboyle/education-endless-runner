...
/// <summary>
/// Displays today's daily challenge using <see cref="DailyChallengeData"/>.
/// Builds a compact panel at runtime when Inspector refs are missing.
/// </summary>
public class DailyChallengeDisplay : MonoBehaviour
{
    ...
    public void Refresh()
    {
        Challenge challenge = DailyChallengeData.GetTodayChallenge();
        if (challenge == null || challengeDescriptionText == null) return;

        challengeDescriptionText.text = "Daily: " + challenge.Description;
    ...
    {
        var canvasGo = new GameObject("DailyChallengeCanvas");
        ...
        var panel = new GameObject("DailyPanel");
        ...
        progressBarFill.color = new Color(0.3f, 0.8f, 1f, 0.9f);
